...
classifier.add(Dense(units=36, activation='softmax')) # softmax for more than 2  # unit= 4 nombre des label des sortie
#7output neurons
...
classifier.fit_generator(
        training_set,
        steps_per_epoch=13, # No of images in training set
        epochs=20,#number of terations
